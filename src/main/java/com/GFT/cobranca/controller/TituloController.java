...
public class TituloController {
	...
	public String salvar(@Validated Titulo titulo,  Errors errors ,RedirectAttributes attributes) {
		...
		if (errors.hasErrors())
			...
			titulos.save(titulo);
			attributes.addFlashAttribute("mensagem", "Sua conta foi paga com sucesso ");
			
		return "redirect:/financa/novo";
	...
	public String excluir(@PathVariable Long codigo ,RedirectAttributes attributes) {
		...
		attributes.addFlashAttribute("mensagem", " Conta foi excluida com sucesso ");
